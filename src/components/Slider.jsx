                    ...
                    <Slider {...settings}>
                        ...
                        <div className="relative h-[27rem] bg-right bg-cover bg-clip-border bg-image-1">
                            <div className="absolute inset-0 flex flex-col-reverse md:flex-row h-full">
                                {/* Left side content */}
                                <div className="bg-gradient-to-r from-indigo-800 to-blue-400 w-1/2 sm:w-[75%] h-full flex flex-col justify-center p-6 sm:p-10 rounded-tr-xl sm:rounded-tr-none">
                                ...
                                <div className="w-screen h-full relative flex items-center justify-end">
                                    {/* Likes count */}
                                    <div className="absolute top-4 pr-20 sm:pr-6 text-[0.6rem] bg-black bg-opacity-70 text-white px-3 py-1 rounded-full flex items-center z-10">
                        ...
                        <div className="relative h-[27rem] bg-right bg-cover bg-clip-border bg-image-2">
                            <div className="absolute inset-0 flex flex-col-reverse md:flex-row h-full">
                                {/* Left side content */}
                                <div className="bg-gradient-to-r from-indigo-800 to-blue-400 w-1/2 sm:w-[45%] h-full flex flex-col justify-center p-6 sm:p-10 rounded-tr-xl sm:rounded-tr-none">
                                ...
                                {/* Right side content */}
                                <div className="w-full md:w-1/4 h-full relative flex items-center justify-end">
                                    {/* Likes count */}
                                    <div className="absolute top-4 right-6 text-[0.6rem] bg-black bg-opacity-70 text-white px-3 py-1 rounded-full flex items-center z-10">
                                        2.1K <FaRegStar className="ml-2 border-white" />
                                    </div>
                                </div>
                            </div>
