...
const SearchBar = () => {
    ...
    return (
        <div className='px-4'>
            <div className="flex bg-gradient-to-r from-indigo-400 via-purple-400 to-blue-600 items-center bg-gray-100 rounded-full gap-4 p-[2px] w-auto max-w-3xl mx-auto shadow-md">
